...
* Envoyer son pseudo à un admin actif sur le Discord pour qu'il vous rajoute au projet
* Télécharger Git (ou GitHub desktop ou autre gestionnaire Git graphique)
* Lancez une fois Github Desktop ou [cloner le repo git](https://www.malekal.com/git-clone-utilisation-et-exemples/)
* Depuis la page web ouvrir le projet vers GitHub Desktop (ou transfert par SSH)
...
Regardez les vidéos de [Kaan Aplar](https://www.youtube.com/@KaanAlparGameDev/videos), il explique très bien. Je vous recommande [celle-ci](https://www.youtube.com/watch?v=9u6edV5-EEI) pour commencer. 
