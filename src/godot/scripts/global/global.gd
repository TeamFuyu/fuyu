...
@export var characters_textures = ["contours/who_portrait_contour.png","fuyu_portrait_contour/0.png", "tous sprites de vieux/0.png"]
@export var characters_colors = ["brown","purple", "white"]
